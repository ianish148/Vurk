      ...
      <main className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="space-y-8 text-base leading-relaxed">
          <p>
            ...
            Terms of Service outline the rules and guidelines users must agree to in order to use your app.
          </p>
          
          <h2 className="text-2xl font-semibold tracking-tight mt-10 mb-4">1. Acceptance of Terms</h2>
          <p>
            By accessing and using this service, you accept and agree to be bound by the terms and provision of this agreement.
          </p>

          <h2 className="text-2xl font-semibold tracking-tight mt-10 mb-4">2. User Conduct</h2>
          <p>
            Users are responsible for all activities that occur under their account. Explain what behavior is not allowed.
          </p>

          <h2 className="text-2xl font-semibold tracking-tight mt-10 mb-4">3. Termination</h2>
          <p>
            Describe the circumstances under which a user's account may be terminated.
          </p>
        </div>
      </main>
